...
#import "PotLimitOmaha8Villain.h"
#import "Card.h"
#import "CardView.h"
#import "Deck.h"
#import "Hand.h"
...
@implementation PotLimitOmaha8Villain
...
- (Move*) riverMove {
	...
	/*MadeHand* lo8Hand0 = [[MadeHand alloc] init];
	MadeHand* lo8Hand1 = [[MadeHand alloc] init];
	
	NSComparisonResult lo8Result = [Hand 
								 calcOmahaLo8WinnerHoleCard0:gameModeView.heroCard0View.card 
								 holeCard1:gameModeView.heroCard1View.card
								 holeCard2:gameModeView.heroCard2View.card
								 holeCard3:gameModeView.heroCard3View.card
								 holeCard4:gameModeView.villainCard0View.card
								 ...
								 communityCard3:gameModeView.communityCard3View.card
								 communityCard4:gameModeView.communityCard4View.card
								 bestHandForFirstPlayer:lo8Hand0
								 bestHandForSecondPlayer:lo8Hand1];
	
	if (lo8Hand0.loHandType == kLoHandNoLo) {
...
- (void)villainFirstToAct {
	timer = [NSTimer scheduledTimerWithTimeInterval:3 target:self selector:@selector(villainFirstToActTimerMethod) userInfo:nil repeats:NO];
}
