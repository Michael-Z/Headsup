...
@interface StudGameModeView : UIView {
	...
	IBOutlet UILabel *heroStackLabel, *heroActionLabel, *heroAmountLabel;
	IBOutlet UILabel *villainStackLabel, *villainActionLabel, *villainAmountLabel;
	IBOutlet UILabel *potLabel;
	IBOutlet UILabel *whoWonLabel;
		
	IBOutlet UIButton *betRaiseButton, *checkCallButton, *foldButton;
	IBOutlet UIButton *doubleBetRaiseButton;
	...
	IBOutlet UILabel *howMuchMoreToDoubleBetRaiseLabel;
...
@property (nonatomic, retain) IBOutlet UIButton *doubleBetRaiseButton;
...
@property (nonatomic, retain) IBOutlet UILabel *howMuchMoreToDoubleBetRaiseLabel;
