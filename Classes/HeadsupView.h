...
@interface HeadsupView : UIView <UIAlertViewDelegate> {
	...
	*communityCard3View, *communityCard4View;
	...
	IBOutlet UILabel *dealerButtonLabel, *blindLabel, *whoActsFirstLabel;
	...
	//BOOL showMyHandToVillainButtonEnabled;
...
@property (nonatomic, retain) IBOutlet UILabel *dealerButtonLabel;
@property (nonatomic, retain) IBOutlet UILabel *blindLabel;
@property (nonatomic, retain) IBOutlet UILabel *whoActsFirstLabel;
