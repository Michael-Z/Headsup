...
{
	//if ([super conformsToProtocol:@protocol(NSNetServiceDelegate)]) {
	/*if ([super respondsToSelector:@selector(netService:didNotPublish:)]) {
		[(id<NSNetServiceDelegate>)super netService:sender didNotPublish:errorDict];
	}*/
